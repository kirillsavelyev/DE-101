...
inner join dw.geo_dim geo on o.postal_code=geo.postal_code and geo.country=o.country and geo.city = o.city and o.state = geo.state --City Burlington doesn't have postal code
